...
| `src/app/(app)/perfil/` · `settings/` | Perfil propio (F3.10: forma de perfil público + "Tu gente" + estantes; `siguiendo/`·`seguidores/`) y Ajustes (absorbió instalar/admin/cerrar sesión tras el chip) |
