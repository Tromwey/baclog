 ...
 * line, the count ribbon, the three 44 px actions — then the body's own
 * rhythm (gap 30): "dónde ver" with its 56 row, the synopsis, and the
 * reviews' section title. No tint: without the cover there is no colour
    ...
    <main aria-busy="true" className="relative mx-auto min-h-dvh w-full max-w-md bg-bg pb-14">
      ...
      <div className={SKELETON_PULSE}>
        ...
        <div className="flex flex-col gap-[30px] px-6 pt-2.5">
          ...
          <div className="h-[26px] w-28 rounded-full bg-surface-2" />
        </div>
      </div>
    </main>
  );
