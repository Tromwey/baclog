  ...
  return (
    <form onSubmit={submit} className="mt-8 space-y-3">
      <input
        ...
        className="w-full rounded-xl border border-neutral-700 bg-neutral-900 px-4 py-3 text-center outline-none focus:border-neutral-400"
      />
      <button
        type="submit"
      ...
      {refCode && (
        <p className="text-xs text-neutral-500">Entras con una invitación 🎟️</p>
      )}
